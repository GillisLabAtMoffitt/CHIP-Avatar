...
jpeg(paste0(path, "/Output Survivals/PFS Radiation from drugs date.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = germline_patient_data,
           title = "PFS Radiation",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
mysurv <- Surv(time = germline_patient_data$month_at_os, event = germline_patient_data$os_surv_cor)
myplot <- survfit(mysurv~Radiation, data = germline_patient_data)
jpeg(paste0(path, "/Output Survivals/OS Radiation from drugs date.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = germline_patient_data,
