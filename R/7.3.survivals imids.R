...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = IMIDs)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs,
...
myplot <- survfit(mysurv~CH_status, data = IMIDs)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH IMIDs.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs,
           title = "OS from diagnosisin IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
           font.y = c(20, "bold", "black"),
           font.legend = c(20, "bold", "black"),
...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs,
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH noIMIDs.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs,
...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs MM patients from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = IMIDs_MM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs MM patients from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs_MM,
           title = "PFS from drug in IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
myplot <- survfit(mysurv~CH_status, data = IMIDs_MM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH IMIDs MM patients.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs_MM,
...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs MM patients from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs_MM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs MM patients from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs_MM,
           title = "PFS from drug in no IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs_MM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH noIMIDs MM patients.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs_MM,
           title = "OS in no IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs SM patients from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = IMIDs_SM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH IMIDs SM patients from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs_SM,
           title = "PFS from drug in IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
myplot <- survfit(mysurv~CH_status, data = IMIDs_SM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH IMIDs SM patients.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = IMIDs_SM,
           title = "OS in IMIDs patients",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
...
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs SM patients from Dx.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs_SM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH noIMIDs SM patients from drug.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs_SM,
...
myplot <- survfit(mysurv~CH_status, data = No_IMIDs_SM)
# jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS  CH noIMIDs SM patients.jpeg"), width = 1200, height = 900)
ggsurvplot(myplot, data = No_IMIDs_SM,
...
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS Dx CH status Mgus patients with IMIDs.jpeg"), width = 1200, height = 900)
...
# myplot <- survfit(mysurv~CH_status, data = IMIDs_Mgus)
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS Drug CH status Mgus patients with IMIDs.jpeg"), width = 1200, height = 900)
# ggsurvplot(myplot, data = IMIDs_Mgus,
#            title = "PFS from drug in IMIDs patients",
#            font.main = c(24, "bold", "black"),
#            font.x = c(20, "bold", "black"),
...
# myplot <- survfit(mysurv~CH_status, data = IMIDs_Mgus)
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS Dx CH status Mgus patients with IMIDs.jpeg"), width = 1200, height = 900)
# ggsurvplot(myplot, data = IMIDs_Mgus,
#            title = "OS in IMIDs patients",
#            font.main = c(24, "bold", "black"),
#            font.x = c(20, "bold", "black"),
...
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS Dx CH status Mgus patients with No IMIDs.jpeg"), width = 1200, height = 900)
...
# myplot <- survfit(mysurv~CH_status, data = No_IMIDs_Mgus)
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS Drug CH status Mgus patients with No IMIDs.jpeg"), width = 1200, height = 900)
# ggsurvplot(myplot, data = No_IMIDs_Mgus,
#            title = "PFS from drug in IMIDs patients",
#            font.main = c(24, "bold", "black"),
#            font.x = c(20, "bold", "black"),
...
# myplot <- survfit(mysurv~CH_status, data = No_IMIDs_Mgus)
# # jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS Dx CH status Mgus patients with No IMIDs.jpeg"), width = 1200, height = 900)
# ggsurvplot(myplot, data = No_IMIDs_Mgus,
#            title = "OS in IMIDs patients",
#            font.main = c(24, "bold", "black"),
#            font.x = c(20, "bold", "black"),
...
myplot <- survfit(mysurv~CH_status+received_IMIDs, data = germline_patient_data_seqsimp)

surv_diff <- survdiff(mysurv~CH_status+received_IMIDs, data = germline_patient_data_seqsimp)
surv_diff

surv_pvalue(myplot)
coxfit <- coxph(
  Surv(time = germline_patient_data_seqsimp$month_at_os, event = germline_patient_data_seqsimp$os_surv_cor) ~ CH_status+received_IMIDs,
  data = germline_patient_data_seqsimp,
  ties = 'exact')
summary(coxfit)

## jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/CH status vs IMIDs OS.jpeg"), width = 1200, height = 900)
ggsurv <- ggsurvplot(myplot, data = germline_patient_data_seqsimp,
...
myplot <- survfit(mysurv~CH_status+received_IMIDs, data = germline_patient_data_seqsimp)
## jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH vs IMIDs from drug.jpeg"), width = 1200, height = 900)
ggsurv <- ggsurvplot(myplot, data = germline_patient_data_seqsimp,
...
# LPreT
PreT <- germline_patient_data_seqsimp %>% filter(Disease_Status_germline == "Pre Treatment Newly Diagnosed Multiple Myeloma")
mysurv <- Surv(time = PreT$month_at_os, event = PreT$os_surv_cor)
myplot <- survfit(mysurv~CH_status+received_IMIDs, data = PreT)


## jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/OS CH vs IMIDs in PreT patients.jpeg"), width = 1200, height = 900)
...
myplot <- survfit(mysurv~CH_status+received_IMIDs, data = PreT)
## jpeg(paste0(path, "/Figures/Survivals/CHIP/IMIDs/PFS CH vs IMIDs in PreT patients from drug.jpeg"), width = 1200, height = 900)
ggsurv <- ggsurvplot(myplot, data = PreT,
           title = "PFS from drugs",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"),
